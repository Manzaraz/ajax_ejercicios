...
Hoy _JavaScript_, es el único lenguaje capaz de ejecutarse en las 3 capas de una aplicaciónÑ 

1. _Frontend_(con _JavaScript_).
1. _Backend_(con _Node.js_).
1. Persistencia de Datos(con _MongoDB_, _CouchDB_, _Firebase_, etc).
